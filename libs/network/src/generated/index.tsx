...
export type ReportsQuery = { __typename?: 'Query', reports: Array<{ __typename?: 'Report', id: number }> };
...
export type CreateWitnessMutation = { __typename?: 'Mutation', createWitness: { __typename?: 'Witness', uid: string } };
...
export type SearchCasesQuery = { __typename?: 'Query', searchCases: Array<{ __typename?: 'Report', case?: { __typename?: 'Case', status: Status, id: number, missingPerson: { __typename?: 'MissingPerson', images: Array<string>, displayName: string, gender: Gender } } | null, location?: { __typename?: 'Location', address: string, latitude: number, longitude: number } | null }> };
...
export type CaseQuery = { __typename?: 'Query', case: { __typename?: 'Case', id: number, contact: Array<string>, status: Status, missingPerson: { __typename?: 'MissingPerson', displayName: string, description: string, missingSince?: any | null, gender: Gender, dob?: any | null, height?: number | null, weight?: number | null, images: Array<string> }, reports: Array<{ __typename?: 'Report', time?: any | null, id: number, type: ReportType, audio?: string | null, description: string, approvedReport?: { __typename?: 'ApprovedReport', id: number, description?: string | null } | null, location?: { __typename?: 'Location', latitude: number, longitude: number } | null }> } };
...
export type CreateCaseMutation = { __typename?: 'Mutation', createCase: { __typename?: 'Case', id: number } };

export type OfficerMeQueryVariables = Exact<{ [key: string]: never; }>;


export type OfficerMeQuery = { __typename?: 'Query', officerMe?: { __typename?: 'Officer', uid: string, createdAt: any, name?: string | null, updatedAt: any } | null };

export type WitnessMeQueryVariables = Exact<{ [key: string]: never; }>;


export type WitnessMeQuery = { __typename?: 'Query', witnessMe?: { __typename?: 'Witness', uid: string, createdAt: any, name?: string | null, updatedAt: any } | null };
...
export type CreateOfficerMutation = { __typename?: 'Mutation', createOfficer: { __typename?: 'Officer', uid: string, name?: string | null, createdAt: any, updatedAt: any } };
...
export type UnapprovedReportsQuery = { __typename?: 'Query', reports: Array<{ __typename?: 'Report', id: number, caseId?: number | null, time?: any | null, type: ReportType, audio?: string | null, description: string, createdAt: any, location?: { __typename?: 'Location', latitude: number, longitude: number } | null, witness?: { __typename?: 'Witness', uid: string, name?: string | null } | null }> };
...
export type CreateApprovedReportMutation = { __typename?: 'Mutation', createApprovedReport: { __typename?: 'ApprovedReport', description?: string | null } };

export type CreateReportsMutationVariables = Exact<{
  createReportsInput: Array<CreateReportInputWithoutCaseId> | CreateReportInputWithoutCaseId;
  caseId: Scalars['Int'];
}>;


export type CreateReportsMutation = { __typename?: 'Mutation', createReports: { __typename?: 'Case', id: number } };
...
export const CreateWitnessDocument = /*#__PURE__*/ gql`
  ...
  createWitness(createWitnessInput: $createWitnessInput) {
    ...
    `;
export type CreateWitnessMutationFn = Apollo.MutationFunction<CreateWitnessMutation, CreateWitnessMutationVariables>;
 ...
 * });
 */
export function useCreateWitnessMutation(baseOptions?: Apollo.MutationHookOptions<CreateWitnessMutation, CreateWitnessMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateWitnessMutation, CreateWitnessMutationVariables>(CreateWitnessDocument, options);
      }
export type CreateWitnessMutationHookResult = ReturnType<typeof useCreateWitnessMutation>;
export type CreateWitnessMutationResult = Apollo.MutationResult<CreateWitnessMutation>;
export type CreateWitnessMutationOptions = Apollo.BaseMutationOptions<CreateWitnessMutation, CreateWitnessMutationVariables>;
export const SearchCasesDocument = /*#__PURE__*/ gql`
    query searchCases($locationFilter: LocationFilterInput!, $dateFilter: DateFilterInput) {
 ...
 * });
 */
export function useSearchCasesQuery(baseOptions: Apollo.QueryHookOptions<SearchCasesQuery, SearchCasesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SearchCasesQuery, SearchCasesQueryVariables>(SearchCasesDocument, options);
      }
export function useSearchCasesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchCasesQuery, SearchCasesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchCasesQuery, SearchCasesQueryVariables>(SearchCasesDocument, options);
        }
export type SearchCasesQueryHookResult = ReturnType<typeof useSearchCasesQuery>;
export type SearchCasesLazyQueryHookResult = ReturnType<typeof useSearchCasesLazyQuery>;
export type SearchCasesQueryResult = Apollo.QueryResult<SearchCasesQuery, SearchCasesQueryVariables>;
 ...
 * });
 */
export function useOfficerMeQuery(baseOptions?: Apollo.QueryHookOptions<OfficerMeQuery, OfficerMeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<OfficerMeQuery, OfficerMeQueryVariables>(OfficerMeDocument, options);
      }
export function useOfficerMeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OfficerMeQuery, OfficerMeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<OfficerMeQuery, OfficerMeQueryVariables>(OfficerMeDocument, options);
        }
export type OfficerMeQueryHookResult = ReturnType<typeof useOfficerMeQuery>;
export type OfficerMeLazyQueryHookResult = ReturnType<typeof useOfficerMeLazyQuery>;
export type OfficerMeQueryResult = Apollo.QueryResult<OfficerMeQuery, OfficerMeQueryVariables>;
 ...
 * });
 */
export function useWitnessMeQuery(baseOptions?: Apollo.QueryHookOptions<WitnessMeQuery, WitnessMeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<WitnessMeQuery, WitnessMeQueryVariables>(WitnessMeDocument, options);
      }
export function useWitnessMeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<WitnessMeQuery, WitnessMeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<WitnessMeQuery, WitnessMeQueryVariables>(WitnessMeDocument, options);
        }
export type WitnessMeQueryHookResult = ReturnType<typeof useWitnessMeQuery>;
export type WitnessMeLazyQueryHookResult = ReturnType<typeof useWitnessMeLazyQuery>;
export type WitnessMeQueryResult = Apollo.QueryResult<WitnessMeQuery, WitnessMeQueryVariables>;
...
export const UnapprovedReportsDocument = /*#__PURE__*/ gql`
    query unapprovedReports($where: ReportWhereInput, $distinct: [ReportScalarFieldEnum!], $skip: Int, $take: Int, $cursor: ReportWhereUniqueInput, $orderBy: [ReportOrderByWithRelationInput!]) {
  reports(
    where: $where
    distinct: $distinct
    skip: $skip
 ...
 * });
 */
export function useUnapprovedReportsQuery(baseOptions?: Apollo.QueryHookOptions<UnapprovedReportsQuery, UnapprovedReportsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UnapprovedReportsQuery, UnapprovedReportsQueryVariables>(UnapprovedReportsDocument, options);
      }
export function useUnapprovedReportsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UnapprovedReportsQuery, UnapprovedReportsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UnapprovedReportsQuery, UnapprovedReportsQueryVariables>(UnapprovedReportsDocument, options);
        }
export type UnapprovedReportsQueryHookResult = ReturnType<typeof useUnapprovedReportsQuery>;
export type UnapprovedReportsLazyQueryHookResult = ReturnType<typeof useUnapprovedReportsLazyQuery>;
export type UnapprovedReportsQueryResult = Apollo.QueryResult<UnapprovedReportsQuery, UnapprovedReportsQueryVariables>;
export const CreateApprovedReportDocument = /*#__PURE__*/ gql`
    mutation createApprovedReport($createApprovedReportInput: CreateApprovedReportInput!) {
  createApprovedReport(createApprovedReportInput: $createApprovedReportInput) {
    description
  }
}
    `;
export type CreateApprovedReportMutationFn = Apollo.MutationFunction<CreateApprovedReportMutation, CreateApprovedReportMutationVariables>;
 ...
 * });
 */
export function useCreateApprovedReportMutation(baseOptions?: Apollo.MutationHookOptions<CreateApprovedReportMutation, CreateApprovedReportMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateApprovedReportMutation, CreateApprovedReportMutationVariables>(CreateApprovedReportDocument, options);
      }
export type CreateApprovedReportMutationHookResult = ReturnType<typeof useCreateApprovedReportMutation>;
export type CreateApprovedReportMutationResult = Apollo.MutationResult<CreateApprovedReportMutation>;
export type CreateApprovedReportMutationOptions = Apollo.BaseMutationOptions<CreateApprovedReportMutation, CreateApprovedReportMutationVariables>;
export const CreateReportsDocument = /*#__PURE__*/ gql`
    mutation CreateReports($createReportsInput: [CreateReportInputWithoutCaseId!]!, $caseId: Int!) {
