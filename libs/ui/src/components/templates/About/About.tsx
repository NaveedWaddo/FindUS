    ...
    <div className="min-h-screen py-12">
      <div className="max-w-xl">
        ...
        <p className="mt-4 text-lg leading-6 text-gray-600">
          This application is an efficient FindUS poster we use to find
          ...
          <div>
            <div className="max-w-xs bg-white rounded-lg shadow-lg">
              <img
                ...
                src="https://firebasestorage.googleapis.com/v0/b/karthick-findus.appspot.com/o/files%2FScreenshot_20221018-220853.jpg?alt=media&token=aa104dff-1611-4c21-ae69-b1981c5e86d2"
        ...
        <div className="mt-12">
          ...
          <p className="mt-4 text-lg text-gray-600">
            ...
            <Link
              target="_blank"
              href="https://www.linkedin.com/in/naveedwaddo122/"
